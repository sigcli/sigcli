...
function genRandomString(t) {
    var e, r;
    return map_default()((e = fill_default()((r = Array(t))).call(r, void 0)))
        .call(e, function () {
...
function generateLocalId(t) {
    var e,
        ...
        u = concat_default()(
            (e = concat_default()(
                (r = concat_default()(
                    (n = concat_default()((o = ''.concat((+new Date()).toString(16)))).call(
                        o,
                        genRandomString(30),
                    )),
                ).call(n, a)),
            ).call(r, LOCAL_ID_SECRET_VERSION)),
        ).call(e, '000'),
        s = crc32(u);
    return concat_default()((i = ''.concat(u)))
        .call(i, s)
        .substring(0, 52);
}
